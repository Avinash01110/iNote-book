...
export default function Login(props) {
  ...
  const handleSubmit = async (e)=>{
    ...
    console.log(json)
    if(json.success){
      props.showAlert("Successfully logged in","green")
            ...
            <div className="space-y-0 rounded-md shadow-sm">
              <div>
                ...
                <input
                  ...
                  autoComplete="email"
                  required
                  className="relative block w-full rounded-t-md border-0 py-1.5 text-gray-900 ring-1 ring-inset ring-[#0667DA] placeholder:text-gray-400 placeholder:px-2 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-[#0667DA] sm:text-sm sm:leading-6"
              ...
              <div>
                ...
                <input
                  ...
                  required
                  className="relative block w-full rounded-b-md border-0 py-1.5 text-gray-900 ring-1 ring-inset ring-[#0667DA] placeholder:text-gray-400 placeholder:px-2 focus:z-10 focus:ring-2 focus:ring-[#0667DA] sm:text-sm sm:leading-6 "
